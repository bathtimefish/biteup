...
<?php echo $this->Form->create('Like');?>
	<fieldset>
		<legend><?php __('Admin Edit Like'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Like.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Like.id'))); ?></li>
