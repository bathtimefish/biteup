<div class="feeds index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $feed['Feed']['modified']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $feed['Feed']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $feed['Feed']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $feed['Feed']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $feed['Feed']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
